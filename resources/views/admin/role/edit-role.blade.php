    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                {!! Form::textarea('description', $role -> description, ['class' => 'form-control','id' =>
                'description','rows' => '3'])
                !!}
                @error('description')
                <small class="text-danger">{{$message}}</small>
            ...
            <div class="card my-4 border">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            {!! Form::checkbox('permission_id[]',$value->id,
                            in_array($value->id,$role->permissions->pluck('id')->toArray()), ['class' =>
                            'permission','id'
                            =>$value->slug]) !!}
